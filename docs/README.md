...
**Key components:**
- **Delivery Promise Components (`vtex.delivery-promise-components`)**: Split Store Framework blocks for postal code (`shopper-location-setter`), delivery vs pickup (`shipping-method-selector`), and pickup point (`pickup-point-selector`); see the app docs for `required` behavior and reload rules
- **Header regionalization**: Customers set location (ZIP code) and fulfillment preferences to see accurate delivery estimates and shipping options
...
- [Delivery Promise Components](https://github.com/vtex-apps/delivery-promise-components/blob/master/docs/README.md) 
